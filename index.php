...
<head>
    ...
    <title>Knockout Tutorials</title>
</head>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h2>Knockout Tutorials</h2>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Tutorials so far...</h5>
                        <p class="card-text">Links are provided here:</p>

                        <ul class="list-group">
                            <li class="list-group-item">
                                <a href="introduction.php" style="display: block;">Introduction</a>
                            </li>
                            <li class="list-group-item">
